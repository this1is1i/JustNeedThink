  ...
  return (
    <div className="flex h-full flex-col" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
        ...
        {isLoading ? (
          ...
          skills.map((s) => (
            ...
            >
              ...
              <div className="mt-1 truncate text-xs" style={{ color: 'var(--color-text-muted)' }}>{s.description}</div>
      ...
      <div className="flex-1 overflow-auto border-t" style={{ borderColor: 'var(--color-border)' }}>
        {selected ? (
          <div>
            <div className="border-b px-3 py-3 text-sm" style={{ borderColor: 'var(--color-border)' }}>
